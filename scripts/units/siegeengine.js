...
Blocks.navalFactory.plans.add(new UnitFactory.UnitPlan(SpNavT1, 60 * 25, ItemStack.with(Items.silicon, 700, Items.metaglass, 80, Items.copper, 200, Items.lead, 200)));
