...
Blocks.groundFactory.plans.add(new UnitFactory.UnitPlan(Siegeengine, 60 * 25, ItemStack.with(Items.silicon, 2500, Items.prismatic-d-iron, 400, Items.plastanium, 800)));
